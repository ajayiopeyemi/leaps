...
import 'package:leaps/features/notes/presentation/pages/note_pdf_preview.dart' as NoteImagePreview;
import 'package:leaps/features/notes/presentation/widgets/empty_week_view.dart';
import 'package:leaps/features/notes/presentation/widgets/items/pdf_item.dart';
              ...
              Container(
                  ...
                  child: BaseChangeNotifierProvider<ResourcesViewModel>(
                    ...
                    builder: (_, model, child) => StreamProvider<List<Resource>>.value(
                      value: model.getResourcesInWeek2(docId, '${ApiConstants.pdfRoute}'),
                      child: WeekViewBuilder(),
                    ),
                  ))
            ],
              ...
              return GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (BuildContext context) => NoteImagePreview.PdfPreview(
                              resource: resource[index], isForLessonNote: true),
                          fullscreenDialog: true,
                        ));
                  },
                  child: PdfItem(index: index));
            });
    }
  }
}
